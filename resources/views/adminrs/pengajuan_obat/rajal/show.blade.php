                    ...
                    <div class="col-lg-12">
                        <div class="mb-2">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-3">
                                    <input name="pekerjaan1[]" id="pekerjaan1[]" class="form-control form-control-sm" type="text" value="{{ $pasien->idMPekerjaan }}" disabled> 
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-sm-1">
                                    <input name="rhesus" id="rhesus" class="form-control form-control-sm" type="text" value="{{ $pasien->rhesus->nama ?? '' }}" disabled>
                                </div>
                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="ms-panel ms-panel-bshadow-none">
                            ...
                            <div class="ms-panel-body">
                                <form class="needs-validation" action="{{ url("adminRs/pengajuan-obat-rajal")}}/{{ $id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-row">
