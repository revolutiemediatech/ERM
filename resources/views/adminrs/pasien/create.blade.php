...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <form action="{{ url('adminRs/pasienn') }}" method="POST">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <ul class="ms-list d-flex">
                                    @foreach ($golonganDarah as $gd)
                                        <li class="ms-list-item pl-0">
                                            <label class="ms-checkbox-wrap">
                                            <input type="radio" name="idMGoldar" value="{{ $gd->id }}">
                                            <i class="ms-checkbox-check"></i>
                                            </label>
                                            <span> {{ $gd->nama }} </span>
                                        </li>
                                ...
                                <ul class="ms-list d-flex">
                                    @foreach ($rhesus as $r)
                                        <li class="ms-list-item pl-0">
                                            <label class="ms-checkbox-wrap">
                                            <input type="radio" name="idRhesus" value="{{ $r->id }}">
                                            <i class="ms-checkbox-check"></i>
                                            </label>
                                            <span> {{ $r->nama }} </span>
                                        </li>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select id="select-pekerjaan" class="form-control form-control-lg" name="pekerjaan1[]" multiple="multiple">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-control Select2" name="idLokasiPemeriksaan" aria-label="Default select example" required>
