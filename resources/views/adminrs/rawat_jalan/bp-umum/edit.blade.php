    ...
    <div class="content-wrapper">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="ms-panel">
                ...
                <form action="{{ url("adminRs/rawat-jalan/bp-umum")}}/{{ $id }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                                      ...
                                      <tbody>
                                        @foreach ($pilihanPenunjang as $pnj)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url("adminRs/pengajuan-penunjang/delete", ['id' => $pnj->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $pnj->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                                    <form id="delete-form-{{ $pnj->id }}" action="{{ url("adminRs/pengajuan-penunjang/delete", ['id' => $pnj->id]) }}" method="POST" style="display: none;">@csrf</form>
                                                </td>
                                            </tr>
                                        @endforeach
                                      </tbody>
                                      ...
                                      <tbody>
                                        @foreach ($pilihanDiagnosa as $pj)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url("adminRs/pengajuan-labor/delete", ['id' => $pj->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $pj->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                                    <form id="delete-form-{{ $pj->id }}" action="{{ url("adminRs/pengajuan-labor/delete", ['id' => $pj->id]) }}" method="POST" style="display: none;">@csrf</form>
                                                </td>
                                            </tr>
                                        @endforeach
                                      </tbody>
