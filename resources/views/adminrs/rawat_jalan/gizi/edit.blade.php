          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 fle d-flex justify-content-end">
                    <a href="{{ url('admin/bp-gizi') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke admin/bp-gizi , karena pake resource --}}
            <form action="{{ url("admin/bp-gizi")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
