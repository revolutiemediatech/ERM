          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 fle d-flex justify-content-end">
                    <a href="{{ url('admin/laborat') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke admin/laborat , karena pake resource --}}
            <form action="{{ url("admin/laborat")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
