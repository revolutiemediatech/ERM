    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="ms-panel">
            <div class="ms-panel-header">
                <div class="row">
                    <div class="col-lg-6">
                        <h5 class="card-title">{{ $page }} Aktif</h5>
                    </div>
                            ...
                            @foreach ($users as $p)
                                @if($p->status == 1)
                                    <tr>
                                        ...
                                        <td>{{ $p->prefix }} {{ $p->nama }}, {{ $p->suffix }}</td>
                                        <td>{{ $p->role->nama }}</td>
                                        <td>
                                            @if ($p->status == 1)
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('karyawan.destroy', ['id' => $p->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $p->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                            <form id="delete-form-{{ $p->id }}" action="{{ route('karyawan.destroy', ['id' => $p->id]) }}" method="POST" style="display: none;">@csrf</form>
                                        </td>
                                    </tr>
                                @endif
                            @endforeach
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="ms-panel">
            <div class="ms-panel-header">
                <div class="row">
                    <div class="col-lg-6">
                        <h5 class="card-title">{{ $page }} Tidak Aktif</h5>
                    </div>
                    {{-- <div class="col-lg-6 d-flex justify-content-end">
                        <div class="btn-group">
                            <a href="{{ url("$url/create", []) }}" type="button" class="btn btn-lg btn-primary">
