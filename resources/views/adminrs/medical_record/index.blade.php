        ...
        <div class="ms-panel">
            <div class="ms-panel-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex justify-content-end">
                        <div class="btn-group">
                            <a href="{{ url("adminRs/status_keluarga/create") }}" type="button" class="btn btn-lg btn-primary">
                        ...
                        <tbody>
                            @foreach ($status_keluarga as $sk)
                                <tr>
                                    ...
                                    <td>{{ $sk->nama }}</td>
                                    <td>
                                        <a href='{{ url("adminRs/status_keluarga/" . $sk->id, []) }}/edit'><i class='fas fa-pencil-alt ms-text-primary'></i></a>
