            ...
            <div class="card-body">
                <table id="datatable" class="table text-center">
                    <tbody>
                        @if ($users == null)
                            <tr>
                                <td colspan="3" class="text-center">Penanggung Jawab E-Konsultasi Belum di Set</td>
                            </tr>
                        @else
                            <tr>
                                <td class="text-sm-end"><b>Nama Penanggung Jawab</b></td>
                                <td>:</td>
                                <td class="text-sm-start"><b>{{ $users->prefix ?? '' }} {{ $users->nama }}, {{ $users->suffix ?? '' }}</b></td>
                            </tr>
                            
                            <tr>
                                <td class="text-sm-end">No HP Penanggung Jawab</td>
                                <td>:</td>
                                <td class="text-sm-start">{{ $users->no_hp }} </td>
                            </tr>
                        @endif
                    </tbody>
                </table>
                    ...
                    <tbody>
                        @foreach ($topik as $p)
                            <tr>
                                ...
                                <td>
                                    <a href='{{ url("adminRs/pj-topik-eKonsultasi/" . $p->id, []) }}/edit'><i class='fas fa-pencil-alt ms-text-primary'></i></a>
