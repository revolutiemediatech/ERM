          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('adminRs/bed') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke adminRs/daerah , karena pake resource --}}
            <form action="{{ url('adminRs/bed') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control Select2" id="exampleFormControlSelect1"  name="idKamar" required>
