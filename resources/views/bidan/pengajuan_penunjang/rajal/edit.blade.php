    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="ms-panel mb-3">
            <div class="ms-panel-header">
                <div class="row">
                    <div class="col-lg-6">
                        <h5 class="card-title">Detail Data Pasien <b>{{ $diagnosa->pasien->nama }}</b></h5>
                    </div>
                    <div class="col-lg-6 d-flex justify-content-end">
                        <a href="{{ url('bidan/pengajuan-labor') }}/{{ $id }}" class="btn btn-sm btn-primary">Kembali</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input name="nama" id="nama" class="form-control form-control" type="text" value="{{ $diagnosa->pasien->nama }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="colFormLabel" class="col-sm-3 col-form-label">No Rekam Medis</label>
                                <div class="col-sm-9">
                                    <input name="no_index" id="no_index" class="form-control form-control" type="text" value="{{ $diagnosa->pasien->no_index }}" disabled>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input name="nik" id="nik" class="form-control form-control" type="text" value="{{ $diagnosa->pasien->nik }}" disabled>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="colFormLabel" class="col-sm-3 col-form-label">Diagnosis</label>
                                <div class="col-sm-9">
                                    <input name="nik" id="nik" class="form-control form-control" type="text" value="{{ $diagnosa->assesment }}" disabled>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-header">
            ...
            <form action="{{ url("bidan/pengajuan-labor")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
