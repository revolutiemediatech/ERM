          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('bidan/obat') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke bidan/obat , karena pake resource --}}
            <form action="{{ url("bidan/obat")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
