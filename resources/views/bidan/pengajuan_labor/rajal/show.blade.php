                                  ...
                                  @foreach ($pilihanDiagnosa as $pnj)
                                      <tr>
                                          ...
                                          <td>
                                              ...
                                              <a href="{{ url("bidan/pengajuan-labor/delete", ['id' => $pnj->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $pnj->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                              <form id="delete-form-{{ $pnj->id }}" action="{{ url("bidan/pengajuan-labor/delete", ['id' => $pnj->id]) }}" method="POST" style="display: none;">@csrf</form>
                                          </td>
                                      </tr>
                                  @endforeach
                                </tbody>
                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="ms-panel ms-panel-bshadow-none">
                            ...
                            <div class="ms-panel-body">
                                <form class="needs-validation" action="{{ url("bidan/pengajuan-labor")}}/{{ $id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-row">
