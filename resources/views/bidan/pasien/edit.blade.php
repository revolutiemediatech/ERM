          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('bidan/pasienn') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke bidan/pasienn , karena pake resource --}}
            <form action="{{ url("bidan/pasienn")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
