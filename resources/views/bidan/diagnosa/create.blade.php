          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('bidan/diagnosa') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke bidan/diagnosa , karena pake resource --}}
            <form action="{{ url('bidan/diagnosa') }}" method="POST">
