        ...
        <div class="ms-panel-body">
           <h2 class="section-title">About Me 
            <div class="btn-group float-right">
              <a href="{{ url("analisLabor/profile/" . $user->id, []) }}/edit" ><i class="fas fa-pencil-alt ms-text-primary"></i></a>
            </div>
          </h2>
     ...
     <div class="ms-panel ms-panel-fh">
        <div class="ms-panel-body">
           <h2 class="section-title">Basic Information
            <div class="btn-group float-right">
              <a href="{{ url("paramedis/profile/" . $user->id, []) }}/edit" ><i class="fas fa-pencil-alt ms-text-primary"></i></a>
            </div>
           </h2>
