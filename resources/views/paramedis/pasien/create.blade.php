...
<div class="content-wrapper">
    ...
    <form action="{{ url('paramedis/pasienn') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select id="select-cabang" class="form-control Select2" name="idLokasiPemeriksaan" aria-label="Default select example" required>
