        ...
        <div class="ms-panel">
            <div class="ms-panel-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex justify-content-end">
                        <div class="btn-group">
                            <a href="{{ url("paramedis/administrasi/create", []) }}" type="button" class="btn btn-lg btn-primary">
        ...
        $(function() {
            ...
            $('#select-cabang').on('change', function() {
                ...
                // $("#tabel-jquery")({
                    ...
                    processing: true,
                    ajax: {
                        url: baseUrl+'/api/paramedis/getBilling/' + idLokasiPemeriksaan,
                        method: 'POST',
                    },
                });
            });
        ...
        $(function() {
            ...
            $('#select-cabang1').on('change', function() {
                ...
                // $("#tabel-jquery")({
                    ...
                    processing: true,
                    ajax: {
                        url: baseUrl+'/api/paramedis/getAdministrasi/' + idLokasiPemeriksaan,
                        method: 'POST',
                    },
                });
            });
