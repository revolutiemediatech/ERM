          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 fle d-flex justify-content-end">
                    <a href="{{ url('perawat/bp-gigi') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke perawat/bp-gigi , karena pake resource --}}
            <form action="{{ url("perawat/bp-gigi")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
