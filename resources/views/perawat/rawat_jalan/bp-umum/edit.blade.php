...
<div class="content-wrapper">
            ...
            <div class="ms-panel-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 flex d-flex justify-content-end">
                        ...
                        <a href="{{ url('perawat/rawat-jalan/bp-umum') }}" class="btn btn-primary">Kembali</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-lg-12 flex d-flex justify-content-center">
                        <a href="{{ url('perawat/rawat-jalan/history/'. $pasien->id) }}" type="button" class="btn btn-primary">History Kunjungan</a>
                        <a href="{{ url('perawat/gallery/'. $pasien->id) }}" type="button" class="btn btn-lg btn-primary">Gallery Pasien</a>
                        <a href="{{ url('#') }}" type="button" class="btn btn-lg btn-primary">Grafik Kesehatan</a>
                        <a href="{{ url('perawat/rawat-jalan/perpen/'. $pasien->id) }}" type="button" class="btn btn-lg btn-primary">Print Perstujuan/Penolakan</a>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="ms-panel">
            ...
            {{-- otomatis masuk ke perawat/bp-umum , karena pake resource --}}
            <form action="{{ url("perawat/rawat-jalan/bp-umum")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-group"> 
                        ...
                        <div class="mb-3">
                            ...
                            <div class="form-group row ml-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="select-penyakitDahulu" class="form-control form-control-sm" name="riwayat_penyakit_dahulu[]" multiple="multiple">
                            ...
                            <div class="form-group row ml-3">
                                ...
                                <div class="col-sm-10">
                                    <select id="select-riwayatAlergi" class="form-control form-control-sm" name="riwayat_alergi[]" multiple="multiple">
                            ...
                            <div class="col-sm-5">
                                <select id="select-namaPenunjang" class="form-control form-control-sm" name="nama_penunjang[]" multiple="multiple">
                                    @foreach ($penunjang as $pnj)
                                        <option value="{{ $pnj->id }}">{{ $pnj->nama}} - {{ $pnj->pembiayaann->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-2">
                                  ...
                                  <tbody>
                                    @foreach ($pilihanPenunjang as $pnj)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ url("perawat/pengajuan-penunjang/delete", ['id' => $pnj->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $pnj->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                                <form id="delete-form-{{ $pnj->id }}" action="{{ url("perawat/pengajuan-penunjang/delete", ['id' => $pnj->id]) }}" method="POST" style="display: none;">@csrf</form>
                                            </td>
                                        </tr>
                                    @endforeach
                                  </tbody>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-5">
                                <select id="select-labor" class="form-control form-control-sm" name="daftar_labor[]" multiple="multiple">
                                    @foreach ($labor as $lb)
                                        <option value="{{ $lb->id }}">{{ $lb->nama}} - (Stok = {{ $lb->stok_akhir}}) - {{ $lb->pembiayaann->nama }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-sm-2">
                                  ...
                                  <tbody>
                                    @foreach ($pilihanDiagnosa as $pj)
                                        <tr>
                                            ...
                                            <td>{{ $pj->labor->pembiayaann->nama }}</td>
                                            <td>
                                                <a href="{{ url("perawat/pengajuan-labor/delete", ['id' => $pj->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $pj->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                                <form id="delete-form-{{ $pj->id }}" action="{{ url("perawat/pengajuan-labor/delete", ['id' => $pj->id]) }}" method="POST" style="display: none;">@csrf</form>
                                            </td>
                                        </tr>
                                    @endforeach
                                  </tbody>
                               ...
                               <table class="table table-bordered thead-primary">
                                    ...
                                    <tbody>
                                        @foreach ($pilihanAssesment as $pj)
                                            <tr>
                                                <td>{{ $loop->iteration }}</td>
                                                <td>{{ $pj->icdTen->kode_spf }}</td>
                                                <td>{{ $pj->icdTen->nama }}</td>
                                                <td>{{ $pj->pilihan }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                            ...
                            <div class="col-lg-5">
                                ...
                                <ul class="ms-list d-flex">
                                    ...
                                    <li class="ms-list-item pl-0">
                                        ...
                                        <span> Rujuk Poli SP </span>
                                    </li>
                                </ul>
                                <ul class="ms-list d-flex">
                                    <li class="ms-list-item pl-0">
                                        <label class="ms-checkbox-wrap">
                                        <input type="radio" name="idTinLan" value="4">
                                        <i class="ms-checkbox-check"></i>
                                        </label>
                                    ...
                                    <li class="ms-list-item pl-0">
                                        <label class="ms-checkbox-wrap">
                                        <input type="radio" name="idTinLan" value="5">
                                        <i class="ms-checkbox-check"></i>
                                        </label>
                                        <span> Meninggal </span>
                                    </li>
