          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('perawat/laborat') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke perawat/laborat , karena pake resource --}}
            <form action="{{ url('perawat/laborat') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <select id="select-role" class="form-control" name="idLokasiPemeriksaan" required>
                            <option value="">Lokasi Pemeriksaan</option>
