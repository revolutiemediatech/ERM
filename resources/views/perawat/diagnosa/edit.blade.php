          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 fle d-flex justify-content-end">
                    <a href="{{ url('perawat/diagnosa') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke perawat/diagnosa , karena pake resource --}}
            <form action="{{ url("perawat/diagnosa")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
