          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('dokter/diagnosa') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke dokter/diagnosa , karena pake resource --}}
            <form action="{{ url('dokter/diagnosa') }}" method="POST">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <label class="col-form-label pt-0" for="nama">Unit Pelayanan</label>
                        <select id="select-role" class="form-control" name="idMUnitPelayanan" required>
                            <option value="">Unit Pelayanan</option>
                            @foreach ($unitPelayanan as $r)
