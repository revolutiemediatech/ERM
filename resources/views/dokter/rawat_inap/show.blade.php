            ...
            <div class="ms-panel-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex justify-content-end">
                        <a href="{{ url('dokter/rawat-inap/pasien') }}" class="btn btn-sm btn-primary">Kembali</a>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @if ($pasien->status_keluarga == 1)
                                    <td class="text-sm-start">A00 - Kepala Keluarga</td>
                                @elseif ($pasien->status_keluarga == 2)
                                    <td class="text-sm-start">A01 - Ibu</td>
                                @elseif ($pasien->status_keluarga == 3)
                                    <td class="text-sm-start">A02 - Anak</td>
                                @else
                                    <td class="text-sm-start">Belum Diinputkan</td>
                                @endif
                            </tr>
                            <tr>
