                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                <input name="pekerjaan1[]" id="pekerjaan1[]" class="form-control form-control" type="text" value="{{ $pasien->idMPekerjaan }}" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="col-lg-3">
                        <div class="form-row">
                            <div class="col-md-6 mb-5">
                                <a href="{{ url('dokter/rawat-jalan/history/'. $pasien->id) }}" type="button" class="btn btn-lg btn-primary">History Kunjungan</a>
                            </div>
                        ...
                        <div class="form-row">
                            <div class="col-md-6 mb-5">
                                <a href="{{ url('#') }}" type="button" class="btn btn-lg btn-primary">Print Resume</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-lg-5">
                                ...
                                <select id="select-icdTen" class="form-control form-control-sm" name="assesment[]" multiple="multiple">
                                    ...
                                    @foreach ($icdTen as $pit)
                                        <option value="{{ $pit->id }}">{{ $pit->kode}} - {{ $pit->deskripsi}}</option>
                                    @endforeach
                                </select>
                            </div>
