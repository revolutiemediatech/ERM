                    ...
                    <div class="col-lg-6 d-flex justify-content-end">
                        <div class="btn-group">
                            <a href="{{ url("$url/create", []) }}" type="button" class="btn btn-lg btn-primary">
                                <i class="fas fa-plus-square"></i> <b>Tambah Data Penunjang</b>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-body">
                <div class="mb-3">
                    ...
                    <select id="select-cabang" class="form-control" name="idLokasiPemeriksaan" aria-label="Default select example" required>
                        <option value="">Pilih Mitra Sedang di Proses</option>
                    </select>
                </div>
            ...
            $('#select-cabang').on('change', function() {
                ...
                // $("#tabel-jquery")({
                    language: { // tambahin ini ki
                        emptyTable: "Tidak ada data Penunjang",
                        info: "Total: _TOTAL_ Data Penunjang",
                        infoEmpty: "Menampilkan 0 dari 0 Data Penunjang",
                    },
                    responsive:  true,
                    autoWidth: false,
                    processing: true,
                    ajax: {
                        url: baseUrl+'/api/dokter/getPenunjang/' + idLokasiPemeriksaan,
                        method: 'POST',
                    },
                });
            });
