...
@push('modals-and-toasts')
        ...
        <div class="modal-dialog ms-modal-dialog-width">
            <div class="modal-content ms-modal-content-width">
                <div class="modal-header  ms-modal-header-radius-0">
                    <h4 class="modal-title text-white">Tambah Hasil Pengajuan Labor</h4>
                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="ms-panel ms-panel-bshadow-none">
                            ...
                            <div class="ms-panel-body">
                                <form class="needs-validation" action="{{ url("$url")}}/{{ $id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <select id="select-daftar" class="form-control" name="daftar_labor[]" multiple="multiple">
                                                    @foreach ($pilihanDiagnosa as $pnj)
                                                        <option value="{{ $pnj->idLabor }}" selected>{{ $pnj->labor->nama }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <select id="select-hasil" class="form-control" name="hasil_labor[]" multiple="multiple">
                                                    @foreach ($pilihanDiagnosa as $pnj)
                                                        <option value="{{ $pnj->hasil_labor }}" selected>{{ $pnj->hasil_labor }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <div class="input-group">
                                                <select id="select-harga" class="form-control" multiple="multiple" disabled>
                                                    @foreach ($pilihanDiagnosa as $pnj)
                                                        <option value="{{ $pnj->labor->harga }}" selected>{{ $pnj->labor->harga }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-8 mb-3">
                                            ...
                                            <select id="select-pembiayaan" class="form-control" multiple="multiple" disabled>
                                                @foreach ($pilihanDiagnosa as $pnj)
                                                    <option value="{{ $pnj->labor->pembiayaann->nama }}" selected>{{ $pnj->labor->pembiayaann->nama }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
    ...
    <div class="modal fade" id="pempenunModalTambah" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog ms-modal-dialog-width">
            <div class="modal-content ms-modal-content-width">
                <div class="modal-header  ms-modal-header-radius-0">
                    <h4 class="modal-title text-white">Tambah Pengajuan Labor</h4>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-hidden="true">x</button>
                </div>
                <div class="modal-body p-0 text-left">
                    <div class="col-xl-12 col-md-12">
