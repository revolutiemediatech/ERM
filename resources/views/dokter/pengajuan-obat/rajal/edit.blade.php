...
<div class="content-wrapper">
    <div class="col-lg-12 grid-margin stretch-card">
            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 fle d-flex justify-content-end">
                        <a href="{{ url('admin/pengajuan-obt/rawat-jalan') }}" class="btn btn-sm btn-primary">Kembali</a>
                    </div>
                </div>
            </div>
            <div class="card-body">
        ...
        <div class="card">
            ...
            {{-- otomatis masuk ke admin/rawat-jalan , karena pake resource --}}
            <form action="{{ url("admin/pengajuan-obt/rawat-jalan")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
