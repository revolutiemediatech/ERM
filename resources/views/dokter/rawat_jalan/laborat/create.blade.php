          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('dokter/laborat') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke dokter/laborat , karena pake resource --}}
            <form action="{{ url('dokter/laborat') }}" method="POST">
