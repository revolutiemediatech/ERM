    ...
    <div class="content-wrapper">
                ...
                <div class="ms-panel-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 flex d-flex justify-content-end">
                            ...
                            <a href="{{ url('dokter/lansia') }}" class="btn btn-primary">Kembali</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="ms-panel">
                ...
                {{-- otomatis masuk ke dokter/lansia , karena pake resource --}}
                <form action="{{ url("dokter/lansia")}}/{{ $id }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
