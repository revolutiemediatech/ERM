    ...
    <div class="content-wrapper">
                ...
                <div class="ms-panel-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 flex d-flex justify-content-end">
                            ...
                            <a href="{{ url('dokter/bp-gigi') }}" class="btn btn-primary">Kembali</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-12 flex d-flex justify-content-center">
                            <a href="{{ url('dokter/rawat-jalan/history/'. $pasien->id) }}" type="button" class="btn btn-primary">History Kunjungan</a>
                            <a href="{{ url('dokter/gallery/'. $pasien->id) }}" type="button" class="btn btn-lg btn-primary">Gallery Pasien</a>
                            <a href="{{ url('#') }}" type="button" class="btn btn-lg btn-primary">Grafik Kesehatan</a>
                            <a href="{{ url('dokter/rawat-jalan/perpen/'. $pasien->id) }}" type="button" class="btn btn-lg btn-primary">Print Perstujuan/Penolakan</a>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="ms-panel">
                ...
                {{-- otomatis masuk ke dokter/bp-gigi , karena pake resource --}}
                <form action="{{ url("dokter/bp-gigi")}}/{{ $id }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                                      ...
                                      <tbody>
                                        @foreach ($pilihanPenunjang as $pnj)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url("dokter/pengajuan-penunjang/delete", ['id' => $pnj->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $pnj->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                                    <form id="delete-form-{{ $pnj->id }}" action="{{ url("dokter/pengajuan-penunjang/delete", ['id' => $pnj->id]) }}" method="POST" style="display: none;">@csrf</form>
                                                </td>
                                            </tr>
                                        @endforeach
                                      </tbody>
                                      ...
                                      <tbody>
                                        @foreach ($pilihanDiagnosa as $pj)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url("dokter/pengajuan-labor/delete", ['id' => $pj->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $pj->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                                    <form id="delete-form-{{ $pj->id }}" action="{{ url("dokter/pengajuan-labor/delete", ['id' => $pj->id]) }}" method="POST" style="display: none;">@csrf</form>
                                                </td>
                                            </tr>
                                        @endforeach
                                      </tbody>
