          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url("admin/medical_record") }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke admin/daerah , karena pake resource --}}
            <form action="{{ url("admin/status_keluarga") }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="col-form-label">
                            ...
                            <input name="kode" class="form-control" type="number" placeholder="Masukkan Kode Family Folder">
                        </div>
                    </div>
                    <div class="mb-3">
                        <div class="col-form-label">
                            <label class="col-sm-3 col-form-label" for="nama">Nama Family Folder</label>
                            <input name="nama" class="form-control" type="text" placeholder="Masukkan Nama Family Folder">
                        </div>
                    </div>
                </div>
