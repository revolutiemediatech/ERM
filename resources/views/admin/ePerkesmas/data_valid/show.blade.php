                ...
                <div class="table-responsive">
                    <table id="datatable" class="table text-justify">
                        <tbody>
                            ...
                            <tr>
                                <td class="text-sm-end">hari Kunjungan</td>
                                <td>:</td>
                                <td class="text-sm-start">{{ $kunjungan->hari_kunjungan ?? '-' }}</td>
                            </tr>
                            <tr>
                                <td class="text-sm-end">Jam Kunjungan</td>
                                <td>:</td>
                                <td class="text-sm-start">{{ $kunjungan->jadwal_kunjungan ?? '-' }}</td>
                            </tr>
                            <tr>
