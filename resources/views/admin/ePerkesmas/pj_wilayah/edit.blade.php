                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="mitra" id="mitra" class="form-control" type="text" value="{{ $wilayah->faskes->nama }}" disabled>
                        </div>
                        <div class="mb-3">
                            <label class="col-form-label pt-0" for="nama">Nama</label>
                            <input name="nama" id="nama" class="form-control" type="text" value="{{ $wilayah->nama }}" disabled>
                        </div>
                        <div class="mb-3">
                            <div class="form-group">
                                <label>Penanggung Jawab</label>
                                <select class="form-control form-control-lg" id="exampleFormControlSelect1"  name="idPenanggungJawab" required>
                                    @if ($wilayah->idPenanggungJawab != null)
                                        <option value="{{ $wilayah->idPenanggungJawab}}">{{ $wilayah->penanggungjawab->nama }}</option>
                                    @endif
