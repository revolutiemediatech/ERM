                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-content d-flex flex-wrap align-items-center justify-content-between">
                        <div class="section-heading text-left">
                            <h2 class="sec__title">DDTK</h2>
                            <p class="sec__desc font-weight-regular pb-2">Kuesioner Mengenai Skrining Pemeriksaan DDTK</p>
                        </div>
    ...
    <div class="col-lg-8">
        <form action="{{ url("$url/store/", []) }}" method="post" class="MultiFile-intercepted">
                ...
                <div class="form-content contact-form-action row">
                    <div class="col-lg-12 responsive-column">
                        <div class="input-box"><label class="label-text font-weight-bold">Berat Badan<span class="text-danger">*</span></label>
                            <div class="form-group select-contain w-100">
                                <div class="dropdown bootstrap-select select-contain-select">
                                    <input type="text" class="form-control" name="berat_badan" placeholder="ex : 60,5">
                                </div>
                            </div>
                        </div>
                        <div class="input-box"><label class="label-text font-weight-bold">Tinggi Badan<span class="text-danger">*</span></label>
                            <div class="form-group select-contain w-100">
                                <div class="dropdown bootstrap-select select-contain-select">
                                    <input type="text" class="form-control" name="tinggi_badan" placeholder="ex : 150,50">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title d-flex align-items-center justify-content-between">
                        <span><i class="la la-briefcase mr-2 text-gray"></i>KESEHATAN GIGI </span>
                        <span class="font-size-13 text-gray"><span class="text-danger">*</span> Required</span>
                    </h3>
                </div>
                <div class="col-lg-12 responsive-column">
                            ...
                            <div class="dropdown bootstrap-select select-contain-select">
                                <ul class="ms-list d-flex">
                                    <li class="ms-list-item pl-4">
                                        ...
                                        <input type="radio" name="karies_peristen" value="Karies">
                                ...
                                <ul class="ms-list d-flex">
                                    <li class="ms-list-item pl-4">
                                        <label class="ms-checkbox-wrap">
                                        <input type="radio" name="karies_peristen" value="Peristen">
                                        <i class="ms-checkbox-check"></i>
                                        </label>
                                        <span> Peristen </span>
                                    </li>
                                ...
                                <ul class="ms-list d-flex">
                                    <li class="ms-list-item pl-4">
                                        <label class="ms-checkbox-wrap">
                                        <input type="radio" name="karies_peristen" value="Tidak Ada">
                                        <i class="ms-checkbox-check"></i>
                                        </label>
                                        <span> Tidak Ada </span>
                                    </li>
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title d-flex align-items-center justify-content-between">
                        <span><i class="la la-briefcase mr-2 text-gray"></i>KARIES ODONTOGRAM GIGI SUSU </span>
                    </h3>
                </div>
                <div class="form-content contact-form-action row">
                    <div>
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title d-flex align-items-center justify-content-between">
                        <span><i class="la la-briefcase mr-2 text-gray"></i>KARIES ODONTOGRAM GIGI TETAP</span>
                    </h3>
                </div>
                <div class="form-content contact-form-action row">
                    <div>
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title d-flex align-items-center justify-content-between">
                        <span><i class="la la-briefcase mr-2 text-gray"></i>PERSISTENSI ODONTOGRAM GIGI TETAP</span>
                    </h3>
                </div>
                <div class="form-content contact-form-action row">
                    <div>
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title d-flex align-items-center justify-content-between">
                        <span><i class="la la-briefcase mr-2 text-gray"></i>PERSISTENSI ODONTOGRAM GIGI SUSU</span>
                    </h3>
                </div>
                <div class="form-content contact-form-action row">
                    <div>
            ...
            <div class="form-box">
                <div class="form-title-wrap">
                    <h3 class="title d-flex align-items-center justify-content-between">
                        <span><i class="la la-briefcase mr-2 text-gray"></i>KESEHATAN UMUM</span>
                    </h3>
                </div>
                <div class="col-lg-12 responsive-column">
                    <label class="label-text font-weight-bold">CHECKLIST DIBAWAH INI YANG ADA (Kalau Tidak Ada, Kosongkan Saja)</label>
                </div>
                <div class="form-content contact-form-action row">
                    <div class="col-lg-12 responsive-column">
                        <ul class="ms-list d-flex">
                            <li class="ms-list-item pl-4" style="margin-right: 98px">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="serumen_kanan" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> SERUMEN KANAN </span>
                            </li>
                            <li class="ms-list-item pl-4" style="margin-right: 20px">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="serumen_kiri" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> SERUMEN KIRI </span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-12 responsive-column">
                        <ul class="ms-list d-flex">
                            <li class="ms-list-item pl-4" style="margin-right: 90px">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="tonsilitis_kanan" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> TONSILITIS KANAN </span>
                            </li>
                            <li class="ms-list-item pl-4" style="margin-right: 20px">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="tonsilitis_kiri" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> TONSILITIS KIRI </span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-12 responsive-column">
                        <ul class="ms-list d-flex">
                            <li class="ms-list-item pl-4" style="margin-right: 20px">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="kelainan_refraksi_kanan" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> KELAINAN REFRAKSI KANAN </span>
                            </li>
                            <li class="ms-list-item pl-4" style="margin-right: 20px">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="kelainan_refraksi_kiri" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> KELAINAN REFRAKSI KIRI </span>
                            </li>
                        </ul>
                    </div>
                    <div class="col-lg-12 responsive-column">
                        <ul class="ms-list d-flex">
                            <li class="ms-list-item pl-4" style="margin-right: 125px">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="otitis_kanan" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> OTITIS KANAN </span>
                            </li>
                            <li class="ms-list-item pl-4" style="margin-right: 20px">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="otitis_kiri" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> OTITIS KIRI </span>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="form-content contact-form-action row">
                    <div class="col-lg-12 responsive-column">
                        <ul class="ms-list d-flex">
                            <li class="ms-list-item pl-4">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="skabies" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> SKABIES </span>
                            </li>
                    ...
                    <div class="col-lg-12 responsive-column">
                        <ul class="ms-list d-flex">
                            <li class="ms-list-item pl-4">
                                <label class="ms-checkbox-wrap">
                                <input type="checkbox" name="anemia" value="ya">
                                <i class="ms-checkbox-check"></i>
                                </label>
                                <span> ANEMIA </span>
                            </li>
