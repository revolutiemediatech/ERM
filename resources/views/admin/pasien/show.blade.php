                    ...
                    <table id="datatable" class="table text-justify">
                        <tbody>
                            <tr>
                                ...
                                <td><a href="{{ url('admin/rawat-jalan/history/'. $pasien->id) }}" type="button" class="btn btn-sm btn-primary">History Kunjungan</a></td>
                            </tr>
                            <tr>
                                <td class="text-sm-end">NIK</td>
                                <td>:</td>
                                <td class="text-sm-start">{{ $pasien->nik }}</td>
                                <td><a href="{{ url('admin/gallery/'. $pasien->id) }}" type="button" class="btn btn-sm btn-primary">Gallery Pasien</a></td>
                            </tr>
                            <tr>
                                <td class="text-sm-end">No KK</td>
                                <td>:</td>
                                <td class="text-sm-start">{{ $pasien->no_kk }}</td>
                                <td><a href="{{ url('admin/rawat-jalan/perpen/'. $pasien->id) }}" type="button" class="btn btn-sm btn-primary">Print Perstujuan/Penolakan</a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="text-sm-end">Status Dalam Keluarga</td>
                                <td>:</td>
                                <td class="text-sm-start">{{ $pasien->statusKel->kode }} - {{ $pasien->statusKel->nama }}</td>
                            </tr>
                            <tr>
