...
<div class="content-wrapper">
    ...
    <form action="{{ url('admin/rawat-jalan/perpen') }}/{{ $id }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 fle d-flex justify-content-end">
                            <a href='{{ url('admin/rawat-jalan/perpen') }}/{{ $id }}' class="btn btn-primary">Kembali</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="form-row">
                        <div class="col-md-6 mb-3" id="jenis">
                            ...
                            <select id="select-jenis" class="form-control Select2" id="exampleFormControlSelect1"  name="jenis">
                        ...
                        <div id="type-form-1">
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control Select2" id="exampleFormControlSelect1"  name="idUsers">
