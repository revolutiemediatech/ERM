        ...
        <div class="ms-panel">
            <div class="ms-panel-header">
                <div class="row">
                    ...
                    <div class="col-lg-6 flex d-flex justify-content-end">
                        <a href='{{ url("admin/gallery") }}/{{ $pasien->id }}/edit' class="btn btn-primary">Upload</a>                    
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            @foreach ($gallery as $gl)
                                <tr>
                                    ...
                                    @endif
                                    <td>
                                        <a href="{{ url("admin/gallery/delete", ['id' => $gl->id]) }}" onclick="event.preventDefault(); document.getElementById('delete-form-{{ $gl->id }}').submit();"><i class='far fa-trash-alt ms-text-danger'></i></a>
                                        <form id="delete-form-{{ $gl->id }}" action="{{ url("admin/gallery/delete", ['id' => $gl->id]) }}" method="POST" style="display: none;">@csrf</form>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
