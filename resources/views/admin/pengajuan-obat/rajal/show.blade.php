                    ...
                    <div class="col-xl-12 col-md-12">
                        <div class="ms-panel ms-panel-bshadow-none">
                            ...
                            <div class="ms-panel-body">
                                <form class="needs-validation" action="{{ url("admin/pengajuan-obat-rajal")}}/{{ $id }}" method="POST">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-row">
                            ...
                            <div class="ms-panel-body">
                                <form class="needs-validation" action="{{ url("admin/pengajuan-obat-rajal")}}/{{ $id }}" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            <label class="col-form-label pt-0" for="penyakit"><b>Data Obat</b></label>
                                            <select id="select-namaObat1" class="form-control form-control-sm" name="nama_obat1[]" multiple="multiple">
                                                <option value="">Pilih Obat</option>
                                                @foreach ($obat as $ob)
                                        ...
                                        <div class="col-md-4 mb-3">
                                            <label class="col-form-label pt-0" for="penyakit"><b>Dosis</b></label>
                                            <select id="select-dosisObat1" class="form-control form-control-sm" name="dosis1[]" multiple="multiple">
                                                
                                            </select>
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label class="col-form-label pt-0" for="penyakit"><b>Jumlah</b></label>
                                            <select id="select-jumlahObat1" class="form-control form-control-sm" name="jumlah1[]" multiple="multiple">
                                    ...
                                    <div class="form-row">
                                        <div class="col-md-4 mb-3">
                                            <label class="col-form-label pt-0" for="penyakit"><b>Keterangan</b></label>
                                            <select id="select-keteranganObat1" class="form-control form-control-sm" name="keterangan1[]" multiple="multiple">
...
@section('js-custom')
    ...
    <script>
        $(function() {
            ...
            $('#select-namaObat2').select2({
                tags: true,
            });
            $('#select-dosisObat2').select2({
                tags: true,
            });
            $('#select-jumlahObat2').select2({
                tags: true,
            });
            $('#select-keteranganObat2').select2({
                tags: true,
            });
