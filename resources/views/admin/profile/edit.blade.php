          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('admin/profile') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke admin/daerah , karena pake resource --}}
            <form action="{{ url("admin/profile")}}/{{ $id }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="no_wa" id="no_wa" class="form-control" type="text" value="{{ $user->no_wa }}">
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="image" class="col-form-label pt-0">Profile</label>
                        <input type="hidden" name="oldImage" value="{{ $user->gambar }}">
                        @if ($user->gambar)
                            <img src="{{ asset('upload/profile/' . $user->gambar) }}" class="img-preview img-fluid mb-3 col-sm-5 d-block">                                   
                        @else
