...
<div class="ms-profile-overview">
   <div class="ms-profile-cover">
      <img class="ms-profile-img" src="{{ url("upload\profile") }}\{{ session()->get('gambar') }}" alt="people">
      <div class="ms-profile-user-info">
         <h3 class="ms-profile-username text-white">{{ $user->prefix }} {{ $user->nama }}, {{ $user->suffix }}</h3>
        ...
        <div class="ms-panel-body">
           <h2 class="section-title">About Me 
            <div class="btn-group float-right">
              <a href="{{ url("admin/profile/" . $user->id, []) }}/edit" ><i class="fas fa-pencil-alt ms-text-primary"></i></a>
            </div>
          </h2>
