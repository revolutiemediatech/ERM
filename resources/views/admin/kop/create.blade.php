    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-header">
            ...
            <form action="{{ url('admin/kop') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <span class="form-text fs-6 text-muted">File jpg, jpeg, png, dan Max 1 Mb</span>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label class="col-form-label pt-0" for="nama">Kota/Kabupaten</label>
                        <input name="daerah" id="daerah" class="form-control form-control-lg" type="text" placeholder="Ex : Magelang (Nama Kota/Kabupaten saja)" required>
                    </div>
                </div>
