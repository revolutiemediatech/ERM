                    ...
                    <div class="col-lg-6 d-flex justify-content-end">
                        <div class="btn-group">
                            <a href="{{ url("$url/create", []) }}" type="button" class="btn btn-lg btn-primary">
                                <i class="fas fa-plus-square"></i> <b>Tambah Data Kecamatan</b>
                            </a>
                        </div>
                    </div>
                </div>
...
<script>
    $(function() {
        ...
        $('#select-daerah').on('change', function() {
            ...
            $('#tabel-jquery').show();
            var idMDaerah = $('#select-daerah').val();
            ...
            // $("#tabel-jquery")({
                language: { // tambahin ini ki
                    emptyTable: "Tidak ada data Kecamatan",
                    info: "Total: _TOTAL_ Data Kecamatan",
                    infoEmpty: "Menampilkan 0 dari 0 Data Kecamatan",
                },
                responsive:  true,
                autoWidth: false,
                processing: true,
                ajax: {
                    url: baseUrl+'/api/daerahkhusus/getKecamatan/' +idMDaerah,
                    method: 'POST',
                },
                dom: 'Bfrtip',
                buttons: [
