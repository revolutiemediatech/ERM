    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="ms-panel">
                    ...
                    <div class="col-lg-6 d-flex justify-content-end">
                        <div class="btn-group">
                            <a href="{{ url("$url/create", []) }}" type="button" class="btn btn-lg btn-primary">
                                <i class="fas fa-plus-square"></i> <b>Tambah Data Mitra</b>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="ms-panel-body">
                ...
                <div class="mb-3">
                    <label class="col-sm-3 col-form-label">Pilih Desa/Kelurahan</label>
                ...
                <div class="table-responsive" id="tabel-jquery">
                    <table id="isi-tabel" class="table table-striped thead-primary w-100">
                        <thead>
                            <tr>
                                <th width="5%">#</th>
                                <th>Nama</th>
        ...
        $('#select-desa').on('change', function() {
            ...
            // $("#tabel-jquery")({
                language: { // tambahin ini ki
                    emptyTable: "Tidak ada data Mitra",
                    info: "Total: _TOTAL_ Data Mitra",
                    infoEmpty: "Menampilkan 0 dari 0 Data Mitra",
                },
                responsive:  true,
                autoWidth: false,
                processing: true,
                ajax: {
                    url: baseUrl+'/api/tabelkhusussemua/getTabelMitra/' +idMDesa,
                    method: 'POST',
                },
                dom: 'Bfrtip',
            });
