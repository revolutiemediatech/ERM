          ...
          <div class="card-header">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex justify-content-end">
                    <a href="{{ url('admin/penunjang') }}" class="btn btn-sm btn-primary">Kembali</a>
                </div>
            </div>
        </div>
            {{-- otomatis masuk ke admin/daerah , karena pake resource --}}
            <form action="{{ url("admin/penunjang")}}/{{ $id }}" method="post">
                @csrf
                @method('PUT')
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="select-mitra" class="form-control form-control-lg Select2" name="idFaskes" aria-label="Default select example">
                                <option value="{{ $penunjang->idFaskes }}">{{ $penunjang->faskes->nama }}</option>
