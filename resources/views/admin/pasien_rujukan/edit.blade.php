...
<div class="content-wrapper">
    ...
    <form action="{{ url("admin/rujukan")}}/{{ $id }}" method="POST">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex justify-content-end">
                            <a href="{{ url('admin/rujukan') }}" class="btn btn-sm btn-primary">Kembali</a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                ...
                <div class="card-body">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control form-control-lg Select2" id="select2" name="status_keluarga" disabled>
