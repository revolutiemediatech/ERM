    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="ms-panel">
            <div class="ms-panel-header">
                <div class="row">
                    <div class="col-lg-6">
                        <h5 class="card-title">{{ $page }} SD</h5>
                    </div>
            ...
            <div class="ms-panel-body">
                <div class="table-responsive">
                    <table id="basic-1" class="table table-striped thead-primary w-100">
                        ...
                        <tbody>
                            @foreach ($answerPenerima_sd as $ap)
                                <tr>
                                    ...
                                    <td>
                                        {{-- <a href='{{ url("admin/responden/edit/" . $ap->id, []) }}'><i class='fas fa-pencil-alt ms-text-primary'></i></a> --}}
                                        <a href='{{ url("$url/jawaban/" . $ap->id, []) }}'><i class='fas fa-eye ms-text-primary'></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="ms-panel">
            <div class="ms-panel-header">
                <div class="row">
                    <div class="col-lg-6">
                        <h5 class="card-title">{{ $page }} SMP</h5>
                    </div>
                    <div class="col-lg-6 d-flex justify-content-end">
                        <a href="{{ url("$url") }}" class="btn btn-sm btn-primary">Kembali</a>
                    </div>
            ...
            <div class="ms-panel-body">
                <div class="table-responsive">
                    <table id="basic-2" class="table table-striped thead-primary w-100">
                        ...
                        <tbody>
                            @foreach ($answerPenerima_smp as $ap1)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $ap1->nama }}</td>
                                    ...
                                    <td>
                                        {{-- <a href='{{ url("admin/responden/edit/" . $ap->id, []) }}'><i class='fas fa-pencil-alt ms-text-primary'></i></a> --}}
                                        <a href='{{ url("$url/jawaban/" . $ap1->id, []) }}'><i class='fas fa-eye ms-text-primary'></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="ms-panel">
            <div class="ms-panel-header">
                <div class="row">
                    <div class="col-lg-6">
                        <h5 class="card-title">{{ $page }} SMA</h5>
                    </div>
                    <div class="col-lg-6 d-flex justify-content-end">
                        <a href="{{ url("$url") }}" class="btn btn-sm btn-primary">Kembali</a>
                    </div>
            ...
            <div class="ms-panel-body">
                <div class="table-responsive">
                    <table id="basic-3" class="table table-striped thead-primary w-100">
                        ...
                        <tbody>
                            @foreach ($answerPenerima_sma as $ap2)
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                    <td>{{ $ap2->nama }}</td>
                                    ...
                                    <td>
                                        {{-- <a href='{{ url("admin/responden/edit/" . $ap->id, []) }}'><i class='fas fa-pencil-alt ms-text-primary'></i></a> --}}
                                        <a href='{{ url("$url/jawaban/" . $ap2->id, []) }}'><i class='fas fa-eye ms-text-primary'></i></a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
