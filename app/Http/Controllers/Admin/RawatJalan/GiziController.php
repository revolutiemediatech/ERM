...
{
    private $views      = 'admin/rawat_jalan/gizi';
    private $url        = 'admin/rawat-jalan/infeksi';
    private $title      = 'Halaman Data Infeksi';
    protected $mDiagnosa;
    protected $mObat;
    protected $mPasien;
    protected $mLabor;
    ...
    public function index()
    {
        ...
        // $diagnosa = $this->mDiagnosa->where('idMUnitPelayanan', 7)->get();
        $data = [
            'title'         => $this->title,
            'url'           => $this->url,
            'page'          => 'Halaman Data Infeksi',
            'pasien'        => $pasien
        ];
