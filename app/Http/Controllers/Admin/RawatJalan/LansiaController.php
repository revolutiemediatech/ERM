...
{
    private $views      = 'admin/rawat_jalan/lansia';
    private $url        = 'admin/rawat-jalan/lansia';
    ...
    public function index()
    {
        ...
        // $diagnosa = $this->mDiagnosa->where('idMUnitPelayanan', 2)->get();
        $data = [
            'title'         => $this->title,
            'url'           => $this->url,
    ...
    {
        // $obat = $this->mObat->get();
        // $pasien = $this->mPasien->where('idMUnitPelayanan', 2)->get();
