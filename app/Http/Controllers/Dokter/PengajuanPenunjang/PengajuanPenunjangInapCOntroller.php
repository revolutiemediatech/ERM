...
namespace App\Http\Controllers\Dokter\PengajuanPenunjang;
...
{
    private $views      = 'dokter/pengajuan_penunjang/ranap';
    private $url        = 'dokter/dokter/pengajuan-penunjang-inap';
