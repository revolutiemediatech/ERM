...
namespace App\Http\Controllers\Dokter\PengajuanLabor;
...
{
    private $views      = 'dokter/pengajuan_labor/rajal';
    private $url        = 'dokter/pengajuan-labor';
    ...
    public function show($id)
    {
        ...
        // echo json_encode($pilihanDiagnosa); die;
