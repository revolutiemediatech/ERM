...
{
    private $views      = 'adminRs/medical_record';
    private $url        = 'adminRs/medical_record';
    private $title      = 'Halaman Data Medical Record';

    public function __construct()
    {
        // Di isi Construct
        $this->mMedical = New MedicalRecordModel();
    }
    public function index()
    {
        $medical_rep = $this->mMedical->where('idFaskes', session()->get('idFaskes'))->get();
    ...
    public function destroy($id)
    {
        ...
        return redirect("adminRs/medical_record")->with('sukses', 'Data Kode Wilayah' . $medical_rec->kode_wilayah . ' berhasil di hapus');
    }
}
