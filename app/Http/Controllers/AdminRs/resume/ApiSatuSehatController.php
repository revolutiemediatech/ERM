...
{
    private $views      = 'adminRs/resumee/api_satu_sehat';
    private $url        = 'adminRs/api-satu-sehat';
    ...
    {
        $api_satuSehat = $this->mApiSatuSehat->where('idFaskes', session()->get('idFaskes'))->get();
