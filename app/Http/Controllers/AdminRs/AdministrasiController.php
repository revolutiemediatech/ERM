...
{
    private $views      = 'adminRs/administrasi';
    private $url        = 'adminRs/administrasi';
    ...
    public function store(Request $request)
    {
        ...
        return redirect("admin/billing")->with('sukses', 'Data Administrasi berhasil di tambahkan');
    }
    ...
    {   
        ...
        return redirect("admin/billing")->with('sukses', 'Data Administrasi berhasil di edit');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect("admin/billing")->with('sukses', 'Data Administrasi Rp' . $administrasi->harga . ' berhasil di hapus');
    }
}
