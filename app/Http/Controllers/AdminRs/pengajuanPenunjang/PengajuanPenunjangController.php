...
namespace App\Http\Controllers\AdminRs\pengajuanPenunjang;
...
{
    private $views      = 'adminRs/pengajuan_penunjang/rajal';
    private $url        = 'adminRs/pengajuan-penunjang';
    ...
    {   
        ...
        if ($request->has('nama_penunjang')) {
            ...
            DB::table('pengajuan_penunjang')->update($dataPengPenun);
    ...
    public function destroy($id)
    {
        ...
        return redirect("$this->url/". $id)->with('sukses', 'Data Pengajuan Penunjang Rawat Jalan ' . $pengajuan_penunjang->nama . ' berhasil di hapus');
    }
}
