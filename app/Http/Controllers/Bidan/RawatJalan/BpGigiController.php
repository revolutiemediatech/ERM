...
{
    private $views      = 'bidan/rawat_jalan/bp-gigi';
    private $url        = 'bidan/bp-gigi';
    ...
    public function create()
    {
        ...
        $cabang = $this->mCabang->where('idFaskes', session()->get('idFaskes'),)->get();
        $data = [
            'title'         => $this->title,
            'url'           => $this->url,
